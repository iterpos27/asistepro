...
export async function reviewSolicitud(id, decision, comentario, datos_adicionales, reemplazo_empleado_id) { const response = await api.post(`/solicitudes/${id}/revisar`, { decision, comentario, datos_adicionales, reemplazo_empleado_id }); return response.data.data; }
