...
function params(req, limit, offset) { return { empresaId: req.query.empresa_id, usuarioId: req.query.usuario_id, entidad: req.query.entidad, metodo: req.query.metodo, fechaDesde: req.query.fecha_desde, fechaHasta: req.query.fecha_hasta, search: req.query.search, limit, offset }; }
